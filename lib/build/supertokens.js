...
const userDeleter_1 = require("./core/userDeleter");
class SuperTokens {
    constructor(config) {
        var _a, _b;
        this.sendTelemetry = () =>
            ...
            return (request, response, next) =>
                __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (requestRID !== undefined) {
                        ...
                        return yield this.handleAPI(matchedRecipe, id, request, response, next, path, method);
                    } else {
                        ...
                        for (let i = 0; i < this.recipeModules.length; i++) {
                            ...
                            if (id !== undefined) {
                                return yield this.handleAPI(
                                    this.recipeModules[i],
                                    id,
                                    request,
                                    response,
                                    next,
        ...
        this.handleAPI = (matchedRecipe, id, request, response, next, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                try {
                    yield utils_1.assertThatBodyParserHasBeenUsed(request, response);
                    return yield matchedRecipe.handleAPIRequest(id, request, response, next, path, method);
                } catch (err) {
                    return next(err);
                }
            });
        ...
        this.deleteUser = (userId) =>
            __awaiter(this, void 0, void 0, function* () {
                const deleter = yield userDeleter_1.UserDeleter.create(
                    querier_1.Querier.getNewInstanceOrThrowError(this.isInServerlessEnv, undefined)
                );
